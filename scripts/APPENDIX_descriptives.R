...
data_clean <- data_clean %>%
  ...
  mutate(q78_1d = case_when(q78_1 < 3 ~ as.numeric(0), TRUE ~ as.numeric(1)))
...
table_desc <- 
  tbl_summary(
    ...
    label = c(
      q78_1d ~ "Abstract free speech (q78_1d)",
      expq80value ~ "Ideologically-oriented speech (DV Experiment, q80)",
